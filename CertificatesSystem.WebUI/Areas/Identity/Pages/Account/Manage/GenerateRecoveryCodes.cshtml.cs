...
namespace CertificatesSystem.WebUI.Areas.Identity.Pages.Account.Manage
{
    public class GenerateRecoveryCodesModel : PageModel
    {
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            {
                throw new InvalidOperationException($"No se pudieron generar los códigos de recuperación para el usuario porque no tiene la 2FA habilitada.");
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            StatusMessage = "Usted ha generado nuevos códigos de recuperación.";
